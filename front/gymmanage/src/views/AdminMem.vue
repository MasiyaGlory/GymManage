            ...
            <el-form ref="dataAddForm" :model="formData" :rules="rules" label-position="right" label-width="100px">
              ...
              <el-row>
                ...
                <el-col :span="8">
                  ...
                  <el-form-item label="余额" prop="allmoney">

                    <el-input  type="text" v-model="formData.allmoney"/>
            ...
            <el-form ref="dataEditForm" :model="formData" :rules="rules" label-position="right" label-width="100px">
              ...
              <el-row>
                ...
                <el-col :span="8">
                  ...
                  <el-form-item label="余额" disabled prop="allmoney">
...
export default {
  ...
  methods: {
    ...
    getAll() {
      //发送ajax请求
      axios.get('http://localhost:8080/AdminMem/getAll').then((res) => {
    ...
    handleAdd() {
      //发送ajax请求
      axios.post('http://localhost:8080/AdminMem/', this.formData).then((res) => {
        console.log(res.data);
        //如果操作成功，关闭弹层，显示数据
    ...
    handleUpdate(row) {
      ...
      //查询数据，根据id查询
      axios.get('http://localhost:8080/AdminMem/' + row.cardnum).then((res) => {
    ...
    handleEdit() {
      //发送ajax请求
      axios.put('http://localhost:8080/AdminMem', this.formData).then((res) => {
        //如果操作成功，关闭弹层，显示数据
        console.log(res.data)
    ...
    handleDelete(row) {
      ...
      this.$confirm("This action will delete it forever,Confirm?", "warning", {
        ...
        //2.做删除业务
        axios.delete('http://localhost:8080/AdminMem/' + row.cardnum).then((res) => {
          res.data
        }).finally(() => {
          this.getAll();
        });
